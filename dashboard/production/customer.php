              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form" method="post" action="customer.php" enctype="multipart/form-data">
                      ...
                      <label for="fullname">Date Join * :</label>
                    ...
                    <?php 
                      if(isset($_POST['submit'])) {
                        ...
                        $query = "INSERT INTO customer(id_customer, name_customer, phone_customer, email_customer, password_customer, date_join_customer) VALUES('','$name','$phone','$email','$password','$date')";
